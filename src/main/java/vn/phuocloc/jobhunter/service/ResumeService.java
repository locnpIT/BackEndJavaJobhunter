...
import vn.phuocloc.jobhunter.domain.Job;
import vn.phuocloc.jobhunter.domain.Resume;
import vn.phuocloc.jobhunter.domain.User;
import vn.phuocloc.jobhunter.repository.JobRepository;
import vn.phuocloc.jobhunter.repository.ResumeRepository;
import vn.phuocloc.jobhunter.repository.UserRepository;
import vn.phuocloc.jobhunter.response.ResultPaginationDTO;
import vn.phuocloc.jobhunter.response.resume.ResCreateResumeDTO;
import vn.phuocloc.jobhunter.response.resume.ResFetchResumeDTO;
import vn.phuocloc.jobhunter.response.resume.ResUpdateResumeDTO;
